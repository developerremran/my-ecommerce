...
const MobileNavBer = () => {
    return (
        <div className='mainWidth'>
            <div className="navbar   bg-[#5E8D95] text-white ">
                <div className="navbar-start">
                    <div className="dropdown bg-[#5E8D95]">
                        <label tabIndex={0} className="btn btn-ghost btn-circle">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                        </label>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content bg-[#5E8D95] mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <div className="dropdown dropdown-end">
                            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                                <div className="w-10 rounded-full">
                                    <img src="https://i.ibb.co/qDqr6KQ/emran-removebg.png" />
                                </div>
                            </label>
